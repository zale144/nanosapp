...
func (srv *AdCampaignService) GetAll(ctx context.Context, req *proto.Request, rsp *proto.Response) error {
	...
	rsp.AdCampaigns = srv.mapAdCampaigns(adCampaigns...)

	return nil
}

// mapAdCampaigns converts the model.AdCampaign to proto.AdCampaign type
func (srv *AdCampaignService) mapAdCampaigns(adCampaigns ...model.AdCampaign) []*proto.AdCampaign {
